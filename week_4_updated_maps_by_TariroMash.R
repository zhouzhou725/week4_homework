...
#------------------------------------------------------------------------------
# Part 4: Alternative ways to visualise the gii data 
#------------------------------------------------------------------------------

# make a simple plot to show the gii_2010 data 
plot(world_w_gii_gdf %>% select(all_of(c("GII 2010","geometry"))))

# make a simple plot to show the gii_2019 data 
plot(world_w_gii_gdf %>% select(all_of(c("GII 2019","geometry"))))

# make a simple plot to show the difference in gii data 
plot(world_w_gii_gdf %>% select(all_of(c("GII difference","geometry"))))
